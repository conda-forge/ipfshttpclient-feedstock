...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ipfshttpclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10592&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ipfshttpclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ipfshttpclient` can be installed with:

```
conda install ipfshttpclient
```

It is possible to list all of the versions of `ipfshttpclient` available on your platform with:
